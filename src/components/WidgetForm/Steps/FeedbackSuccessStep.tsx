  ...
  return (
    <>
      ...
      <button 
        ...
        type="button"
        className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-700 focus:ring-orange-500 disabled:opacity-70 hover:disabled:bg-orange-500"
      >
        Quero enviar outro
      </button>
      </div>
